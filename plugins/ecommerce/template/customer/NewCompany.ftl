...
<div class="row">
  <div class="col-12">
    <fieldset>
      <legend>${uiLabelMap.CommonCompanyInfo}</legend>
      <input type="hidden" name="emailProductStoreId" value="${productStoreId}"/>

      <div class="row form-group">
        <div class="col-12">
          <label class="required-field" for="COMPANY_NAME">${uiLabelMap.CommonCompanyName}</label>
          <@fieldErrors fieldName="groupName"/>
          <input type="text" name="groupName" id="groupName" value="${requestParameters.groupName!}"
            maxlength="100"class="form-control form-control-sm"/>
        </div>
      </div>
      <div class="row form-group">
        <div class="col-12 col-md-6">
          <label class="required-field" for="VAT_ID">${uiLabelMap.AccountingVatId}</label>
          <@fieldErrors fieldName="TAX_ID"/>
          <input type="text" name="TAX_ID" id="TAX_ID" value="${requestParameters.TAX_ID!}"
            maxlength="50" class="form-control form-control-sm"/>
        </div>

        <div class="col-12 col-md-6">
          <label class="required-field" for="CONTACT">${uiLabelMap.ContactPerson}</label>
          <@fieldErrors fieldName="CONTACT"/>
          <input type="text" name="CONTACT" id="CONTACT" value="${requestParameters.CONTACT!}"
          maxlength="50"class="form-control form-control-sm"/>
        </div>
      </div>
    ...
    <hr/>
    <fieldset>
      <legend>${uiLabelMap.PartyBillingAddress}</legend>
      <div class="row form-group">
        <div class="col-12 text-muted font-italic mb-3" style="max-width:600px;">
          <strong>${uiLabelMap.CommonNote}:</strong>${uiLabelMap.CompanyBillingAddressNote}
        </div>
      </div>
      <div class="row form-group">
        <div class="col-12 col-md-6">
      ...
      <div class="col-12 col-md-6 table-responsive">
        <table class="table"
          ...
          <tbody>
            ...
            <tr>
              <th scope="row" style="vertical-align:middle;">${uiLabelMap.PartyBusinessPhone}</th>
              <td>
                <input type="text" inputmode="tel" name="CUSTOMER_WORK_CONTACT" class="form-control form-control-sm"
                  value="${requestParameters.CUSTOMER_WORK_CONTACT!}"/>
              </td>
            </tr>
          </tbody>
        </table>
