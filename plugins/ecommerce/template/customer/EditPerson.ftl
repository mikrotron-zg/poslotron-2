...
<div class="card">
  <div class="card-header">
    <h3>${uiLabelMap.PartyEditPersonalInformation}</h3>
  </div>
  <div class="card-body">
    ...
    <div class="form-group mt-4">
      ...
      <a id="editpersonform3" href="javascript:document.editpersonform.submit()" class="btn btn-outline-primary">${uiLabelMap.CommonSave}</a>
    </div>
  </div>
</div>