...
-->
<#escape x as x?xml>
  <fo:table table-layout="fixed" font-size="10pt" margin-top="5mm" border-spacing="3pt">
          ...
          <fo:block>
            ...
            <#if quote.partyId??>
              ...
              <fo:block font-family="NotoSans-Bold">
                ${quotePartyNameResult.fullName?default("[${uiLabelMap.OrderPartyNameNotFound}]")}
              </fo:block>
            <#else>
  ...
  <fo:table table-layout="fixed" font-size="9pt" border-spacing="3pt" space-before="5mm" space-after="10mm">
    ...
    <fo:table-body>
      ...
      <fo:table-row>
        ...
        <fo:table-cell><fo:block>${(quote.validFromDate?string("dd. MM. yyyy."))!}</fo:block></fo:table-cell>
      </fo:table-row>
      <fo:table-row>
        <fo:table-cell><fo:block>${uiLabelMap.CommonValidThruDate}:</fo:block></fo:table-cell>
        <fo:table-cell><fo:block>${(quote.validThruDate?string("dd. MM. yyyy."))!}</fo:block></fo:table-cell>
      </fo:table-row>
      ...
      <#if quoteLevelTerms?has_content && quoteLevelTerms.size() gt 0>
        <fo:table-row>
          <#list quoteLevelTerms as quoteLevelTerm>:
            <fo:table-cell><fo:block>${quoteLevelTerm.getRelatedOne("TermType", false).get("description",locale)}:</fo:block></fo:table-cell>
            <fo:table-cell>              
              <fo:block>
                ${quoteLevelTerm.termValue?default("")} ${quoteLevelTerm.termDays?default("")} ${quoteLevelTerm.textValue?default("")}
              </fo:block>
              </#list>
            </fo:table-cell>
        </fo:table-row>
