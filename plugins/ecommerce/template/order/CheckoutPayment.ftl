...
<div class="container" style="max-width:600px;">
            ...
            <div class="card-body">
                ...
                <div>
                  ...
                  <div class="form-check">
                      <input type="radio" class="form-check-input" id="checkOutPaymentId_OFFLINE" name="checkOutPaymentId" value="EXT_OFFLINE" <#if "EXT_OFFLINE" == checkOutPaymentId>checked="checked"</#if> checked/>
                  ...
                  <#-- not working, commenting this out
                  <div>
    ...
    <div class="row">
      ...
      <div class="col-auto">
        <a href="javascript:submitForm(document.getElementById('checkoutInfoForm'), 'DN', '');" class="btn btn-primary">${uiLabelMap.CommonNext}</a>
      </div>
    </div>
</div>