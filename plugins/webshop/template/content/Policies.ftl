      ...
      <li id="returns" class="list-group-item">
        <#if (locale == "hr")>
          ...
          <p>
            ...
            o povratu robe na e-mail <a href="mailto:shop@diykits.eu">shop@diykits.eu</a> i neoštećeni proizvod 
        ...
        <#else>
          ...
          <p>
            ...
            to send a notification about the return of the goods to e-mail <a href="mailto:shop@diykits.eu">shop@diykits.eu</a>
      ...
      <li id="complaints" class="list-group-item">
        <#if (locale == "hr")>
          ...
          <p>
            ...
            (<a href="mailto:shop@diykits.eu">shop@diykits.eu</a>). Kako bi smo ubrzali postupak, molimo pripremite broj
        ...
        <#else>
          ...
          <p>
            ...
            (<a href="mailto:shop@diykits.eu">shop@diykits.eu</a>). In order to speed up the process, please prepare the purchase 
      ...
      <li id="privacy" class="list-group-item">
        <#if (locale == "hr")>
          ...
          <p id="cookies">
            ...
            ne utječe na funkcionalnost web trgovine.
