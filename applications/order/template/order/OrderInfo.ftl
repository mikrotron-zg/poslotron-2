...
<div class="screenlet order-info">
    <div class="screenlet-title-bar">
        <div style="display: flex; justify-content: space-between;">
            ...
            <div class="h1" style="float: left; font-weight: bold;">
                &nbsp;${(orderType.get("description", locale))?default(uiLabelMap.OrderOrder)}&nbsp;${uiLabelMap.CommonNbr}&nbsp;
                <a href="<@ofbizUrl>orderview?orderId=${orderId}</@ofbizUrl>">${orderId}</a>
                ${externalOrder!}
                [&nbsp;<a href="<@ofbizUrl>order.pdf?orderId=${orderId}</@ofbizUrl>" target="_blank">${uiLabelMap.CommonPdf}</a>&nbsp;]
            </div>
