...
/**
 * Custom permissive policy that preserves target="_blank" on links
 * and uses rel="noopener noreferrer" instead of "nofollow"
 */
public class CustomPermissivePolicyWithBlankTarget implements SanitizerCustomPolicy {
    ...
    public static final PolicyFactory POLICY_DEFINITION = new HtmlPolicyBuilder()
            ...
            // Allow rel attributes with various values
            .allowAttributes("rel").matching(Pattern.compile("(noopener noreferrer|nofollow|noopener|noreferrer)")).onElements("a")
